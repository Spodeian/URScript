...
## Attributions
This version of this library is built with [nalgebra](https://nalgebra.org) as a core dependency.
Nalgebra uses the [Apache 2.0 license](http://www.apache.org/licenses/LICENSE-2.0).
